...
class main_API:
    ...
    def __init__(self, ui) -> None:
        ...
        self.API_Page_CameraSetting.set_back_event_func(self.get_camera_paprameter_main_API)   # introduce and send the name of the  "get_camera_paprameter_main_API"  function to API_Page_CameraSetting to call this function when the parameters of the camera is changed
