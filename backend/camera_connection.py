...
class Collector:
    ...
    def start_grabbing_error_handling(self, error):
        ...
        # expossure invalid
            ...
            "OutOfRangeException thrown in node 'ExposureTimeAbs' while calling 'ExposureTimeAbs.SetValue()"
            in str(error)
        ):
            # min
        ...
        # gain invalid
            ...
            "OutOfRangeException thrown in node 'GainRaw' while calling 'GainRaw.SetValue()"
            in str(error)
        ):
        ...
        # packetsize invalid
            ...
            "OutOfRangeException thrown in node 'GevSCPSPacketSize' while calling 'GevSCPSPacketSize.SetValue()"
            in str(error)
        ):
        ...
        # transmission delay
            ...
            "OutOfRangeException thrown in node 'GevSCFTD' while calling 'GevSCFTD.SetValue()"
            in str(error)
        ):
            if "must be equal or greater than" in str(error):
        ...
        # height delay
            ...
            "OutOfRangeException thrown in node 'Height' while calling 'Height.SetValue()"
            in str(error)
        ):
            if "must be equal or greater than" in str(error):
        ...
        # width delay
            ...
            "OutOfRangeException thrown in node 'Width' while calling 'Width.SetValue()"
            in str(error)
        ):
            if "must be equal or greater than" in str(error):
        ...
        # offsetx delay
            ...
            "OutOfRangeException thrown in node 'OffsetX' while calling 'OffsetX.SetValue()"
            in str(error)
        ):
            if "must be equal or greater than" in str(error):
        ...
        # offsety delay
            ...
            "OutOfRangeException thrown in node 'OffsetY' while calling 'OffsetY.SetValue()"
            in str(error)
        ):
            if "must be equal or greater than" in str(error):
